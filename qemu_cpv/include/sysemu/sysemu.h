...
typedef struct QEMURamfile {
    const char *name;
    uint64_t addr;
} QEMURamfile;
extern QEMURamfile ramfile[MAX_RAMFILES];
extern int nb_ramfile;

#define MAX_CANBUSES 4
extern char const *host_canbus[MAX_CANBUSES];
...
extern QemuOptsList qemu_can_opts;
