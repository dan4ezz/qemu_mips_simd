...
DEF("ramfile", HAS_ARG, QEMU_OPTION_ramfile,
    "-ramfile name=<file>,addr=<addr>\n"
...
DEF("can", HAS_ARG, QEMU_OPTION_can,
"-can canid=canid,canbus=canbus\n"
"                Connect canid can device to host canbus\n"
"                canid=  id of can device\n"
"                canbus= name of host canbus (i.e. vcan0) \n",
QEMU_ARCH_ALL)
STEXI
@item -can
@findex -can
Connect virtual can device to host bus
ETEXI
