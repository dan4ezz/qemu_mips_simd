...
static const char * const cpvregnames[] = {
    "c0.d0",  "c0.d1",  "c1.d0",  "c1.d1",
    "c2.d0",  "c2.d1",  "c3.d0",  "c3.d1",
    "c4.d0",  "c4.d1",  "c5.d0",  "c5.d1",
    "c6.d0",  "c6.d1",  "c7.d0",  "c7.d1",
    "c8.d0",  "c8.d1",  "c9.d0",  "c9.d1",
    "c10.d0", "c10.d1", "c11.d0", "c11.d1",
    "c12.d0", "c12.d1", "c13.d0", "c13.d1",
    "c14.d0", "c14.d1", "c15.d0", "c15.d1",
    "c16.d0", "c16.d1", "c17.d0", "c17.d1",
    "c18.d0", "c18.d1", "c19.d0", "c19.d1",
    "c20.d0", "c20.d1", "c21.d0", "c21.d1",
    "c22.d0", "c22.d1", "c23.d0", "c23.d1",
    "c24.d0", "c24.d1", "c25.d0", "c25.d1",
    "c26.d0", "c26.d1", "c27.d0", "c27.d1",
    "c28.d0", "c28.d1", "c29.d0", "c29.d1",
    "c30.d0", "c30.d1", "c31.d0", "c31.d1",
    "c32.d0", "c32.d1", "c33.d0", "c33.d1",
    "c34.d0", "c34.d1", "c35.d0", "c35.d1",
    "c36.d0", "c36.d1", "c37.d0", "c37.d1",
    "c38.d0", "c38.d1", "c39.d0", "c39.d1",
    "c40.d0", "c40.d1", "c41.d0", "c41.d1",
    "c42.d0", "c42.d1", "c43.d0", "c43.d1",
    "c44.d0", "c44.d1", "c45.d0", "c45.d1",
    "c46.d0", "c46.d1", "c47.d0", "c47.d1",
    "c48.d0", "c48.d1", "c49.d0", "c49.d1",
    "c50.d0", "c50.d1", "c51.d0", "c51.d1",
    "c52.d0", "c52.d1", "c53.d0", "c53.d1",
    "c54.d0", "c54.d1", "c55.d0", "c55.d1",
    "c56.d0", "c56.d1", "c57.d0", "c57.d1",
    "c58.d0", "c58.d1", "c59.d0", "c59.d1",
    "c60.d0", "c60.d1", "c61.d0", "c61.d1",
    "c62.d0", "c62.d1", "c63.d0", "c63.d1",
};
...
static void gen_k64rio_cp2(CPUMIPSState *env, DisasContext *ctx)
{
#define rs(i)       ((i >> 21) & 0x1f)
#define s_immed(i)  ((int16_t) (i & 0x0ffff))
#define cp2_nd(i)   ((uint16_t) ((i >> 17) & 0x01))
#define cp2_bc_offset(i) (s_immed(i) << 2)
    uint32_t opcode = ctx->opcode;
    TCGv_i32 t_opcode;
    TCGv_i32 t_pc = tcg_const_i32((uint32_t) ctx->pc);

    LOG_DISAS("\nCP2 ++++++++++++ opcode = %x\n", opcode);

    t_opcode = tcg_const_i32(opcode);
    ...
    case OPC_LDC2:
    {
        ...
        int flags;
        int base = rs(opcode);
        int16_t offset = s_immed(opcode);

        if (MASK_OP_MAJOR(opcode) == OPC_LDC2) {
            ldc2 = true;
            flags = MO_BEQ;
        } else {
            ldc2 = false;
        ...
        t1 = tcg_temp_new();
        gen_base_offset_addr(ctx, t0, base, offset);
        tcg_gen_qemu_ld_tl(t1, t0, ctx->mem_idx, flags);

        gen_helper_cp2_ldc2(cpu_env, t_opcode, t1, tcg_const_i32(ldc2));
        return;
    }
    default:
        /* Fallthrough to the next switch */
        break;
    }

    switch (MASK_CP2(opcode)) {
    case OPC_MFC2:
        gen_helper_cp2_mfc2(cpu_env, t_opcode, tcg_const_i32(0), t_pc);
        break;
    case OPC_DMFC2:
        gen_helper_cp2_mfc2(cpu_env, t_opcode, tcg_const_i32(1), t_pc);
        break;
    case OPC_MTC2:
        gen_helper_cp2_mtc2(cpu_env, t_opcode, tcg_const_i32(0), t_pc);
        break;
    case OPC_DMTC2:
        gen_helper_cp2_mtc2(cpu_env, t_opcode, tcg_const_i32(1), t_pc);
        break;
    case OPC_BC2:
        gen_helper_cp2_bc2(bcond, cpu_env, t_opcode);
        ctx->btarget = ctx->pc + 4 + cp2_bc_offset(opcode);
        ctx->hflags |= MIPS_HFLAG_BDS32;
        ctx->hflags |= cp2_nd(opcode) ? MIPS_HFLAG_BL : MIPS_HFLAG_BC;
        break;
    default:
        MIPS_INVAL("CP2 instruction");
        generate_exception_end(ctx, EXCP_RI);
    }
...
static void gen_cpv(CPUMIPSState *env, DisasContext *ctx)
{
    uint32_t opcode = ctx->opcode;

#define CPV_HELPER_GEN(helper, op) \
    do {                                            \
        TCGv_i32 t_opcode = tcg_const_i32(op);      \
        helper(cpu_env, t_opcode);                  \
        tcg_temp_free_i32(t_opcode);                \
    } while (0)

#define CPV_HELPER_GEN2(helper, op, t) \
    do {                                            \
        TCGv_i32 t_opcode = tcg_const_i32(op);      \
        TCGv_i32 tt = tcg_const_i32(t);             \
        helper(cpu_env, t_opcode, tt);              \
        tcg_temp_free_i32(t_opcode);                \
        tcg_temp_free_i32(tt);                      \
    } while (0)

#define CPV_HELPER_GEN_VB(helper, op, flags) \
    do {                                            \
        TCGv_i32 t_opcode = tcg_const_i32(op);      \
        helper(bcond, cpu_env, t_opcode);           \
        tcg_temp_free_i32(t_opcode);                \
        ctx->btarget = ctx->pc + 4 + cpv_vb_offset(op); \
        ctx->hflags = flags;                        \
    } while (0)

    LOG_DISAS("\nCPV ++++++++++++\n opcode = %x\n", opcode);

    switch (opcode & 0xfc000001) {
    case OPC_VLD:
        /* 4 least significant bits of VLDX are 0110 = 0x6.
         * So all *X instructions have in common these 0x6. */
        CPV_HELPER_GEN2(gen_helper_cpv_vld, opcode,
                            (opcode & 0x06) == 0x06 ? TYPE_X : 0);
        return;
    case OPC_VSD:
        CPV_HELPER_GEN2(gen_helper_cpv_vsd, opcode,
                            (opcode & 0x06) == 0x06 ? TYPE_X : 0);
        return;
    }

    switch (opcode & 0xfe00005f) {
    case OPC_CHMADD:
        CPV_HELPER_GEN(gen_helper_cpv_chmadd, opcode);
        return;
    case OPC_CHMSUB:
        CPV_HELPER_GEN(gen_helper_cpv_chmsub, opcode);
        return;
    case OPC_CHMUL:
        CPV_HELPER_GEN(gen_helper_cpv_chmul, opcode);
        return;
    case OPC_CMADDSUB:
        CPV_HELPER_GEN(gen_helper_cpv_cmaddsub, opcode);
        return;
    case OPC_CMADD:
        CPV_HELPER_GEN(gen_helper_cpv_cmadd, opcode);
        return;
    case OPC_CMAGSQ2:
        CPV_HELPER_GEN(gen_helper_cpv_cmagsq2, opcode);
        return;
    case OPC_CMSUB:
        CPV_HELPER_GEN(gen_helper_cpv_cmsub, opcode);
        return;
    case OPC_CMUL:
        CPV_HELPER_GEN(gen_helper_cpv_cmul, opcode);
        return;
    case OPC_CONV:
        CPV_HELPER_GEN(gen_helper_cpv_conv, opcode);
        return;
    case OPC_MOVEHH:
        CPV_HELPER_GEN2(gen_helper_cpv_move, opcode, MOVE_HH);
        return;
    case OPC_MOVEHL:
        CPV_HELPER_GEN2(gen_helper_cpv_move, opcode, MOVE_HL);
        return;
    case OPC_MOVELH:
        CPV_HELPER_GEN2(gen_helper_cpv_move, opcode, MOVE_LH);
        return;
    case OPC_MOVELL:
        CPV_HELPER_GEN2(gen_helper_cpv_move, opcode, MOVE_LL);
        return;
    case OPC_MTVMADD:
        CPV_HELPER_GEN(gen_helper_cpv_mtvmadd, opcode);
        return;
    case OPC_MTVMSUB:
        CPV_HELPER_GEN(gen_helper_cpv_mtvmsub, opcode);
        return;
    case OPC_MVMADD:
        CPV_HELPER_GEN(gen_helper_cpv_mvmadd, opcode);
        return;
    case OPC_MVMSUB:
        CPV_HELPER_GEN(gen_helper_cpv_mvmsub, opcode);
        return;
    case OPC_MVMUL:
        CPV_HELPER_GEN(gen_helper_cpv_mvmul, opcode);
        return;
    case OPC_MTVMUL:
        CPV_HELPER_GEN(gen_helper_cpv_mtvmul, opcode);
        return;
    case OPC_PRM:
        CPV_HELPER_GEN(gen_helper_cpv_prm, opcode);
        return;
    case OPC_VADDSUB:
        CPV_HELPER_GEN(gen_helper_cpv_vaddsub, opcode);
        return;
    case OPC_VADD:
        CPV_HELPER_GEN(gen_helper_cpv_vadd, opcode);
        return;
    case OPC_VMADDSUB:
        CPV_HELPER_GEN(gen_helper_cpv_vmaddsub, opcode);
        return;
    case OPC_VMADD:
        CPV_HELPER_GEN(gen_helper_cpv_vmadd, opcode);
        return;
    case OPC_VMSUB:
        CPV_HELPER_GEN(gen_helper_cpv_vmsub, opcode);
        return;
    case OPC_VMUL4:
        CPV_HELPER_GEN(gen_helper_cpv_vmul4, opcode);
        return;
    case OPC_VMUL:
        CPV_HELPER_GEN(gen_helper_cpv_vmul, opcode);
        return;
    case OPC_VSUB:
        CPV_HELPER_GEN(gen_helper_cpv_vsub, opcode);
        return;
    }

    switch (opcode & 0xff80005f) {
    case OPC_CHW:
        CPV_HELPER_GEN(gen_helper_cpv_chw, opcode);
        return;
    }

    switch (opcode & 0xffc0005f) {
    case OPC_VSUM:
        CPV_HELPER_GEN(gen_helper_cpv_vsum, opcode);
        return;
    }

    switch (opcode & 0xffe0005f) {
    case OPC_SMUL:
        CPV_HELPER_GEN(gen_helper_cpv_smul, opcode);
        return;
    }

    switch (opcode & 0xffe000ff) {
    case OPC_VMFCC:
        CPV_HELPER_GEN(gen_helper_cpv_vmfcc, opcode);
        return;
    case OPC_VMTCC:
        CPV_HELPER_GEN(gen_helper_cpv_vmtcc, opcode);
        return;
    }

    switch (opcode & 0xffe0e07f) {
    case OPC_VCFC:
        CPV_HELPER_GEN(gen_helper_cpv_vcfc, opcode);
        return;
    case OPC_VCTC:
        CPV_HELPER_GEN(gen_helper_cpv_vctc, opcode);
        return;
    case OPC_VMFH:
        CPV_HELPER_GEN(gen_helper_cpv_vmfh, opcode);
        return;
    case OPC_VMFHFP:
        CPV_HELPER_GEN(gen_helper_cpv_vmfhfp, opcode);
        return;
    case OPC_VMFL:
        CPV_HELPER_GEN(gen_helper_cpv_vmfl, opcode);
        return;
    case OPC_VMFLFP:
        CPV_HELPER_GEN(gen_helper_cpv_vmflfp, opcode);
        return;
    case OPC_VMTH:
        CPV_HELPER_GEN(gen_helper_cpv_vmth, opcode);
        return;
    case OPC_VMTHFP:
        CPV_HELPER_GEN(gen_helper_cpv_vmthfp, opcode);
        return;
    case OPC_VMTL:
        CPV_HELPER_GEN(gen_helper_cpv_vmtl, opcode);
        return;
    case OPC_VMTLFP:
        CPV_HELPER_GEN(gen_helper_cpv_vmtlfp, opcode);
        return;
    }

    switch (opcode & 0xffe30000) {
    case OPC_VBF:
        CPV_HELPER_GEN_VB(gen_helper_cpv_vbf, opcode,
            ctx->hflags | MIPS_HFLAG_BC | MIPS_HFLAG_BDS32);
        return;
    case OPC_VBFL:
        CPV_HELPER_GEN_VB(gen_helper_cpv_vbf, opcode,
            ctx->hflags | MIPS_HFLAG_BL | MIPS_HFLAG_BDS32);
        return;
    case OPC_VBT:
        CPV_HELPER_GEN_VB(gen_helper_cpv_vbt, opcode,
            ctx->hflags | MIPS_HFLAG_BC | MIPS_HFLAG_BDS32);
        return;
    case OPC_VBTL:
        CPV_HELPER_GEN_VB(gen_helper_cpv_vbt, opcode,
    ...
    switch (opcode & 0xffe00007) {
    case OPC_VCMP:
        CPV_HELPER_GEN(gen_helper_cpv_vcmp, opcode);
        return;
    }

    switch (opcode & 0xffe0000f) {
    case OPC_IFMOVE:
        CPV_HELPER_GEN(gen_helper_cpv_ifmove, opcode);
        return;
    case OPC_IFSET:
        CPV_HELPER_GEN(gen_helper_cpv_ifset, opcode);
        return;
    }

    switch (opcode & 0xfff00000) {
    case OPC_VSCALE:
        CPV_HELPER_GEN(gen_helper_cpv_vscale, opcode);
        return;
    }

    switch (opcode & 0xff00000f) {
    case OPC_SGNMOD:
        CPV_HELPER_GEN(gen_helper_cpv_sgnmod, opcode);
        return;
    }

    switch (opcode & 0xfff0000f) {
    case OPC_VGET:
        CPV_HELPER_GEN(gen_helper_cpv_vget, opcode);
        return;
    case OPC_VLEAST:
        CPV_HELPER_GEN(gen_helper_cpv_vleast, opcode);
        return;
    case OPC_VMOST:
        CPV_HELPER_GEN(gen_helper_cpv_vmost, opcode);
        return;
    case OPC_VRECIP:
        CPV_HELPER_GEN(gen_helper_cpv_vrecip, opcode);
        return;
    case OPC_VRSQRT:
        CPV_HELPER_GEN(gen_helper_cpv_vrsqrt, opcode);
        return;
    case OPC_VSWAP:
        CPV_HELPER_GEN(gen_helper_cpv_vswap, opcode);
        return;
    }

    switch (opcode & 0xfff0005f) {
    case OPC_CSD:
        CPV_HELPER_GEN(gen_helper_cpv_csd, opcode);
        return;
    case OPC_VMAX:
        CPV_HELPER_GEN(gen_helper_cpv_vmax, opcode);
        return;
    case OPC_VMIN:
        CPV_HELPER_GEN(gen_helper_cpv_vmin, opcode);
        return;
    case OPC_VZERO:
        CPV_HELPER_GEN(gen_helper_cpv_vzero, opcode);
        return;
    }

    MIPS_INVAL("CPV instruction");
    generate_exception_end(ctx, EXCP_RI);
#undef CPV_HELPER_GEN
#undef CPV_HELPER_GEN2
#undef CPV_HELPER_GEN_VB
}
...
static void decode_opc(CPUMIPSState *env, DisasContext *ctx)
{
    ...
    case OPC_BALC: /* OPC_SWC2 */
        if (ctx->insn_flags & INSN_K64RIO) {
            /* LDC2 */
            gen_k64rio_cp2(env, ctx);
            break;
        }
        if (ctx->insn_flags & ISA_MIPS32R6) {
            /* OPC_BC, OPC_BALC */
    ...
    case OPC_DAUI: /* OPC_JALX */
        if (ctx->insn_flags & ISA_MIPS32R6) {
            ...
            MIPS_INVAL("major opcode");
#endif
        } else if (ctx->insn_flags & INSN_K64RIO) {
            /* OPC_MDMX2 */
            gen_cpv(env, ctx);
        } else {
            /* OPC_JALX */
                         ...
                         int flags)
{
    ...
    if (env->insn_flags & INSN_K64RIO) {
        for (i = 0; i < 128; i++) {
            if ((i & 3) == 0) {
                cpu_fprintf(f, "CPV%02d:", i >> 1);
            }
            cpu_fprintf(f, " %s " TARGET_FMT_lx,
                        cpvregnames[i], env->cpv[i >> 1].d[i & 1]);
            if ((i & 3) == 3) {
                cpu_fprintf(f, "\n");
            }
        }
...
void mips_tcg_init(void)
{
    ...
    for (i = 0; i < 64; i++) {
        int off = offsetof(CPUMIPSState, cpv[i].d[0]);
        cpv_wr_d[i * 2] =
                tcg_global_mem_new_i64(cpu_env, off, cpvregnames[i * 2]);
        off = offsetof(CPUMIPSState, cpv[i].d[1]);
        cpv_wr_d[i * 2 + 1] =
                tcg_global_mem_new_i64(cpu_env, off, cpvregnames[i * 2 + 1]);
    }
