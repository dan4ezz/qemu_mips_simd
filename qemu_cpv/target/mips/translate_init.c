...
const mips_def_t mips_defs[] =
{
    ...
    {
        .name = "K64RIO",
        .CP0_PRid = 0x05130513ULL,
        .CP0_Config0 =
            (0x1 << CP0C0_M) | (0x4 << CP0C0_K0) | (0x0 << CP0C0_AR) |
            (0x2 << CP0C0_AT) | (MMU_TYPE_R4000 << CP0C0_MT) |
            (0x1 << CP0C0_BE) | (0x1 << CP0C0_DV) | (0x1 << CP0C0_CH) |
            (0x1 << CP0C0_L2) | (0x1 << CP0C0_ICH),
        .CP0_Config1 =
            MIPS_CONFIG1 | (0x1 << CP0C1_FP) | (0x1 << CP0C1_PC) |
            (0x1 << CP0C1_DS) | (0x4 << CP0C1_DL) | (0x3 << CP0C1_DA) |
            (0x1 << CP0C1_IS) | (0x4 << CP0C1_IL) | (0x3 << CP0C1_IA) |
            (0x3f << CP0C1_MMU) | (0x1 << CP0C1_WR) | (0x1 << CP0C1_EP)
#if 0
            | (0x1 << CP0C1_C2)
#endif
            ,
        .CP0_Config2 = MIPS_CONFIG2 | (0x7 << CP0C2_SS) | (0x4 << CP0C2_SL),
        .CP0_Config3 = MIPS_CONFIG3,
        .CP0_LLAddr_rw_bitmask = 0,
        .CP0_LLAddr_shift = 0,
        .SYNCI_Step = 32, /* value based on vmips64 code */
        .CCRes = 0,
        .CP0_Status_rw_bitmask = 0xfcfbffff,
        .CP1_fcr0 = (0x1 << FCR0_F64) | (0x1 << FCR0_PS) | (0x1 << FCR0_D) |
                    (0x1 << FCR0_S) | (0x81 << FCR0_PRID) | (0x01 << FCR0_REV),
        .CP1_fcr31 = 0,
        .CP1_fcr31_rw_bitmask = 0xFF83FFFF,
        .SEGBITS = 40,
        .PABITS = 36,
        .insn_flags = CPU_MIPS64R2 | INSN_K64RIO,
        .mmu_type = MMU_TYPE_R4000,
    },
    {
