                          ...
                          int rs, int16_t imm)
{
    ...
    FILE* log_file = fopen("log_msa", "a");
    if(log_file != 0)
    	fprintf(log_file, "OPC_COPL_LDST\n");
    fclose(log_file);
#endif
        switch (op) {
        case OPC_LDC1:
                          ...
                          int rt, int rs, int16_t imm)
{
    ...
    FILE* log_file = fopen("log_msa", "a");
    if(log_file != 0)
    	fprintf(log_file, "OPC_ARITH_IMM\n");
    fclose(log_file);
#endif
    switch (opc) {
    case OPC_ADDI:
                          ...
                          int rt, int rs, int16_t imm)
{
    ...
    FILE* log_file = fopen("log_msa", "a");
    if(log_file != 0)
    	fprintf(log_file, "OPC_LOGIC_IMM\n");
    fclose(log_file);
#endif
    switch (opc) {
    case OPC_ANDI:
                          ...
                          int rt, int rs, int16_t imm)
{
    ...
    FILE* log_file = fopen("log_msa", "a");
    if(log_file != 0)
    	fprintf(log_file, "OPC_SHIFT_IMM\n");
    fclose(log_file);
#endif
    switch (opc) {
    case OPC_SLL:
                          ...
                          int rd, int rs, int rt)
{
    ...
    FILE* log_file = fopen("log_msa", "a");
    if(log_file != 0)
    	fprintf(log_file, "OPC_COND_MOVE\n");
    fclose(log_file);
#endif
    switch (opc) {
    case OPC_MOVN:
