...
typedef enum BlockdevDriver {
    ...
    BLOCKDEV_DRIVER_THROTTLE = 29,
    BLOCKDEV_DRIVER_VDI = 30,
    BLOCKDEV_DRIVER_VHDX = 31,
    BLOCKDEV_DRIVER_VMDK = 32,
    BLOCKDEV_DRIVER_VPC = 33,
    BLOCKDEV_DRIVER_VVFAT = 34,
    BLOCKDEV_DRIVER_VXHS = 35,
    BLOCKDEV_DRIVER__MAX = 36,
} BlockdevDriver;
