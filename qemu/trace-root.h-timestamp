...
static inline void _nocheck__trace_gdbstub_op_start(char const * device)
{
...
static inline void trace_gdbstub_op_start(char const * device)
{
    if (true) {
...
static inline void _nocheck__trace_gdbstub_op_extra_info(char const * info)
{
...
static inline void trace_gdbstub_op_extra_info(char const * info)
{
    if (true) {
...
static inline void _nocheck__trace_gdbstub_hit_watchpoint(char const * type, int cpu_gdb_index, uint64_t vaddr)
{
...
static inline void trace_gdbstub_hit_watchpoint(char const * type, int cpu_gdb_index, uint64_t vaddr)
{
    if (true) {
...
static inline void _nocheck__trace_gdbstub_io_reply(char const * message)
{
...
static inline void trace_gdbstub_io_reply(char const * message)
{
    if (true) {
...
static inline void _nocheck__trace_gdbstub_io_binaryreply(size_t ofs, char const * line)
{
...
static inline void trace_gdbstub_io_binaryreply(size_t ofs, char const * line)
{
    if (true) {
...
static inline void _nocheck__trace_gdbstub_io_command(char const * command)
{
...
static inline void trace_gdbstub_io_command(char const * command)
{
    if (true) {
