...
static inline void _nocheck__trace_nvme_rw(char const * verb, uint32_t blk_count, uint64_t byte_count, uint64_t lba)
{
...
static inline void trace_nvme_rw(char const * verb, uint32_t blk_count, uint64_t byte_count, uint64_t lba)
{
    if (true) {
...
static inline void _nocheck__trace_nvme_getfeat_vwcache(char const* result)
{
...
static inline void trace_nvme_getfeat_vwcache(char const* result)
{
    if (true) {
